...
public final class Constants {
    ...
    public static final int LEVEL_LIMIT = Integer.MAX_VALUE;                //time limit for a level
    public static final float GHOST_REVERSAL = 0;//0.0015f;        //probability of a global ghost reversal event
    public static final int MAX_TIME = 48000;                    //maximum time a game can be played for
