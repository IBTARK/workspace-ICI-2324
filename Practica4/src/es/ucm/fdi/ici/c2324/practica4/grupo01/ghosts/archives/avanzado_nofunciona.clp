...
(deffunction calcular-closest-distance-index (?ghostType ?lvl)
	(INDEX (owner ?ghostType) (lvl ?lvl) (index ?index) (distance ?id1))
	(not (INDEX (owner ?ghostType) (lvl ?lvl) (distance ?id2&:(< ?id2 ?id1))))
	(return ?index)
)
...
(deffunction devolver-index-objetivo (?ghostType ?lvl)
	...
	(bind ?index =(calcular-closest-distance-index ?ghostType ?lvl))
	(test (neq ?index nil))
...
(defrule flank-lvl1-junctions
	...
	(not (NEARESTGHOST (tipo ?ghostType))) ; SI !NO! SOMOS EL GHOST MAS CERCANO A MSPACMAN
	(INDEX (owner MSPACMAN) (lvl ?lvl) (index ?index) (distance ?idms))
	(INDEX (owner ?ghostType) (lvl ?lvl) (index ?index) (previousIndex ?pri) (distance ?id1&:(< ?id1 ?idms)))
	(not (INDEX (owner ?ghostType) (lvl ?lvl) (distance ?id2&:(< ?id2 ?id1))))
	(bind ?objective ?index)
	=>
	(assert
...
(defrule flank-lvl2-junctions
	...
	(GHOST (tipo ?ghostType) (edible false))
	(not (NEARESTGHOST (tipo ?ghostType))) ; SI !NO! SOMOS EL GHOST MAS CERCANO A MSPACMAN
	(INDEX (owner ?ghostType) (lvl ?lvl) (index ?index) (previousIndex ?pri) (distance ?id1))
	(not (INDEX (owner ?ghostType) (lvl ?lvl) (distance ?id2&:(< ?id2 ?id1))))
	(bind ?objective ?index)
	=>
	(assert
